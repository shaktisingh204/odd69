...
const SPORT_META: Record<string, { emoji: string; label: string; color: string; badgeClass: string; ringClass: string }> = {
  ...
  'sr:sport:12':  { emoji: '🏉', label: 'Rugby',        color: '#8B5CF6', badgeClass: 'from-amber-700 to-amber-500 text-white',      ringClass: 'from-amber-600 via-amber-800 to-amber-900' },
  ...
  'sr:sport:138': { emoji: '🤸', label: 'Kabaddi',      color: '#7C3AED', badgeClass: 'from-amber-800 to-amber-600 text-white',      ringClass: 'from-amber-800 via-amber-700 to-amber-900' },
};
                  ...
                  className={`rounded-full px-3 py-1 text-[10px] font-adx-bold capitalize transition-all duration-150 ${
                    eventsFilter === f
                      ? f === 'live'
                        ...
                        : f === 'upcoming'
                          ? 'bg-brand-gold text-white shadow-[0_2px_8px_rgba(139,92,246,0.08)]'
