...
async function seed() {
    ...
    // 2. Create Event (New Zealand vs Afghanistan) with Live Scores
    const openDate = new Date(); // Live now
    ...
    const markets = [
        ...
        },
        {
            ...
            id: 'MKT_DEL_AFG_001',
            // 0, 1, 2, 3
            // Since we only have back0/1/2, we'll map 0->b0, 1->b1, 2->b2. 3 will be ignored for now due to schema limit.
