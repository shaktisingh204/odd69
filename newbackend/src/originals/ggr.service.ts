...
export class GGRService {
  ...
  private defaults(gameKey: string) {
    const d: Record<string, any> = {
      mines:  { isActive: true,  minBet: 10, maxBet: 100000, targetGgrPercent: 5.0,  displayRtpPercent: 95.0, fakePlayerMin: 200, fakePlayerMax: 300, gameName: 'ODD69 Mines',  gameDescription: 'Dodge the mines, collect the gems.' },
      crash:  { isActive: true,  minBet: 10, maxBet: 50000,  targetGgrPercent: 4.0,  displayRtpPercent: 96.0, fakePlayerMin: 180, fakePlayerMax: 280, gameName: 'ODD69 Crash',  gameDescription: 'Watch the multiplier climb. Cash out in time.' },
      dice:   { isActive: true,  minBet: 10, maxBet: 50000,  targetGgrPercent: 3.0,  displayRtpPercent: 97.0, fakePlayerMin: 120, fakePlayerMax: 220, gameName: 'ODD69 Dice',   gameDescription: 'Roll the dice, beat the house.' },
      limbo:  { isActive: true,  minBet: 10, maxBet: 50000,  targetGgrPercent: 3.5,  displayRtpPercent: 96.5, fakePlayerMin: 140, fakePlayerMax: 240, gameName: 'ODD69 Limbo',  gameDescription: 'Pick your multiplier and beat the bust point.' },
      plinko: { isActive: true,  minBet: 10, maxBet: 25000,  targetGgrPercent: 3.0,  displayRtpPercent: 97.0, fakePlayerMin: 90,  fakePlayerMax: 160, gameName: 'ODD69 Plinko', gameDescription: 'Drop the ball and chase riskier multiplier slots.' },
      keno:   { isActive: false, minBet: 10, maxBet: 25000,  targetGgrPercent: 4.5,  displayRtpPercent: 95.5, fakePlayerMin: 70,  fakePlayerMax: 140, gameName: 'ODD69 Keno',   gameDescription: 'Pick your lucky numbers and hit the board.' },
      hilo:   { isActive: false, minBet: 10, maxBet: 20000,  targetGgrPercent: 4.0,  displayRtpPercent: 96.0, fakePlayerMin: 60,  fakePlayerMax: 110, gameName: 'ODD69 Hi-Lo',  gameDescription: 'Guess whether the next card goes higher or lower.' },
      roulette:{ isActive: false, minBet: 10, maxBet: 50000, targetGgrPercent: 5.3,  displayRtpPercent: 94.7, fakePlayerMin: 80,  fakePlayerMax: 150, gameName: 'ODD69 Roulette', gameDescription: 'Cover your numbers and let the wheel decide.' },
      wheel:  { isActive: false, minBet: 10, maxBet: 25000,  targetGgrPercent: 4.8,  displayRtpPercent: 95.2, fakePlayerMin: 50,  fakePlayerMax: 120, gameName: 'ODD69 Wheel',  gameDescription: 'Spin a fast bonus wheel for instant multipliers.' },
      coinflip:{ isActive: false, minBet: 10, maxBet: 20000, targetGgrPercent: 2.9,  displayRtpPercent: 97.1, fakePlayerMin: 65,  fakePlayerMax: 135, gameName: 'ODD69 Coinflip', gameDescription: 'Call heads or tails and settle each round instantly.' },
      towers: { isActive: false, minBet: 10, maxBet: 20000,  targetGgrPercent: 3.6,  displayRtpPercent: 96.4, fakePlayerMin: 55,  fakePlayerMax: 125, gameName: 'ODD69 Towers',  gameDescription: 'Climb one floor at a time and cash out before you fall.' },
      color:  { isActive: false, minBet: 10, maxBet: 15000,  targetGgrPercent: 4.2,  displayRtpPercent: 95.8, fakePlayerMin: 75,  fakePlayerMax: 155, gameName: 'ODD69 Color',   gameDescription: 'Pick a color lane and ride short, fast multiplier rounds.' },
      lotto:  { isActive: false, minBet: 10, maxBet: 15000,  targetGgrPercent: 5.1,  displayRtpPercent: 94.9, fakePlayerMin: 45,  fakePlayerMax: 95, gameName: 'ODD69 Lotto',   gameDescription: 'Choose your ticket line and chase oversized payout grids.' },
      jackpot:{ isActive: false, minBet: 10, maxBet: 25000,  targetGgrPercent: 5.5,  displayRtpPercent: 94.5, fakePlayerMin: 35,  fakePlayerMax: 85, gameName: 'ODD69 Jackpot', gameDescription: 'Snap into boosted prize pots with a high-volatility hit chase.' },
    };
