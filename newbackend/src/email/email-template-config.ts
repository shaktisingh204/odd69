...
export const defaultEmailTemplateSettings: ManagedEmailTemplateSettingsMap = {
    ...
    'withdrawal-success': {
        enabled: true,
        subject: 'Withdrawal of {{amountLabel}} completed',
        imageUrl: '{{siteUrl}}/sports-hero-banner.png',
        preheader: 'Your {{amountLabel}} withdrawal has been completed on {{platformName}}.',
        eyebrow: 'Payout update',
        title: 'Withdrawal completed',
        lead: 'Hi {{username}}, your withdrawal has been completed and funds have been sent.',
        heroLabel: 'Amount sent',
        heroValue: '{{amountLabel}}',
        heroHelper: '{{processedAt}}',
        heroStatus: 'Completed',
        bodyPrimary: 'Your withdrawal has been completed successfully. Most bank and UPI transfers land within a few hours.',
